    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li {{ request()->is('portfolio') ? 'class=active' : '' }}><a href="{{ route('portfolio') }}">Galery</a></li>
          <li {{ request()->is('services') ? 'class=active' : '' }}><a href="{{ route('service') }}">Layanan</a></li>
          <li {{ request()->is('blog') ? 'class=active' : '' }}><a href="{{ route('blog') }}">Artikel/Berita</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Bergabunglah dengan Buletin Kami
            </h4>
            <p>Berlangganan pembaruan artikel terbaru melalui email</p>
            @if (session('success'))
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">SantriTeladan</a> ・ Developed by <a href="https://codelapan.com/">Oyi_Cak</a>
        </div>
      </div>
